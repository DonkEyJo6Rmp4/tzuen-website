...
const sloganSource = join(root, 'Tzuen', 'assets', 'slogan橫式白.svg');
const sloganOutput = join(output, 'Tzuen', 'assets', 'slogan橫式白.svg');
mkdirSync(join(output, 'Tzuen', 'assets'), { recursive: true });
