const content = {
  'zh-TW': {
    skip: '跳至主要內容', brand: '財團法人佛教慈恩育幼基金', menuLabel: '開啟導覽選單', navAbout: '關於慈恩', navWork: '服務行動', navLegal: '合法立案', navNews: '最新消息', navContact: '聯絡我們',
    heroTitle: '讓自己成為最溫暖的陽光', donateNow: '立即捐款', learnMore: '認識我們', scroll: '向下閱讀',
    aboutEyebrow: '關於慈恩', aboutTitle: '陪伴，不只是一場活動', aboutLead: '財團法人佛教慈恩育幼基金是一個以佛教慈悲精神為根基，長期投入兒少公益服務的非營利組織。', aboutBody: '基金會於民國 67 年 8 月正式核准成立，從教育、文化與慈善三個面向，支持育幼院、安置機構、經濟弱勢家庭及偏鄉地區的兒童與青少年。', founded: '正式成立', tin: '統一編號', pillars: '教育・文化・慈善', registrationShort: '立案字號', aboutImageAlt: '基金會志工陪伴育幼院兒少參與活動', aboutCaption: '把資源送到需要的地方，也把陪伴留在孩子身邊。',
    workEyebrow: '我們的行動', workTitle: '一年四季，讓善意持續發生', workIntro: '從長期陪伴到季節行動，每項服務都有自己的節奏，也共同回應孩子與家庭的需要。',
    legalEyebrow: '公開與信任', legalTitle: '合法立案，資訊透明', legalBody: '財團法人佛教慈恩育幼基金經高雄市政府核准設立，依法推動兒童教育、育幼與社會慈善工作。', orgNameLabel: '組織名稱', orgName: '財團法人佛教慈恩育幼基金', registrationLabel: '立案字號', locationLabel: '所在地', location: '高雄市新興區', establishmentCertificate: '立案證書・點擊查看', legalCertificate: '法人登記證・點擊查看',
  ...
  en: {
    skip: 'Skip to main content', brand: 'Buddhist Tzuen Children’s Welfare Foundation', menuLabel: 'Open navigation menu', navAbout: 'About', navWork: 'Our Work', navLegal: 'Legal Status', navNews: 'News', navContact: 'Contact',
    heroTitle: 'Be the Sunshine That Warms Every Heart.', donateNow: 'Donate', learnMore: 'About Us', scroll: 'Discover more',
    aboutEyebrow: 'About Tzuen', aboutTitle: 'Care goes beyond a single event', aboutLead: 'Buddhist Tzuen Children’s Welfare Foundation is a nonprofit rooted in Buddhist compassion and dedicated to the long-term well-being of children and youth.', aboutBody: 'Officially established in August 1978, the foundation advances education, culture, and charity for children in residential care, low-income families, and underserved communities.', founded: 'Established', tin: 'Tax Identification Number', pillars: 'Education・Culture・Charity', registrationShort: 'Registration', aboutImageAlt: 'Foundation volunteers accompanying children during an activity', aboutCaption: 'We bring resources where they are needed and stay beside each child.',
...
function renderServices(services) {
  document.querySelector('#service-grid').innerHTML = services.map((service, index) => `
    <article class="service-card ${index === 0 || index === 5 ? 'service-card-wide' : ''}">
      <img src="public/images/${service.image}" alt="" width="1600" height="1067" loading="lazy">
...
function setLanguage(language) {
  const selected = content[language] ? language : 'zh-TW';
  ...
  menuButton.setAttribute('aria-label', dictionary.menuLabel);
  ...
  localStorage.setItem('tzuen-language', selected);
}
...
setLanguage(localStorage.getItem('tzuen-language') || 'zh-TW');
